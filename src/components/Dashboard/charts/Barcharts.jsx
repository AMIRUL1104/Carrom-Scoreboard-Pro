...
function Barcharts() {
  return (
    <div className=" max-w-full  md:max-w-125 h-70 mx-auto border border-red-500">
      <ResponsiveContainer width="100%" aspect={1.618} height="100%">
        <BarChart responsive data={data} radius={[10, 10, 0, 0]}>
          <XAxis dataKey="name" tick={{ fontSize: 10, fill: "#aaa" }}></XAxis>
          {/* <YAxis></YAxis> */}
          <Tooltip
            wrapperStyle={{ width: 100, backgroundColor: "#000", fill: "red" }}
          />

          <Bar dataKey="score" fill="#00E5A0" barSize={"25"} />
          {/* <RechartsDevtools /> */}
        </BarChart>
      </ResponsiveContainer>
    </div>
